...
export default function CoordinatorAppPreferences() {
    ...
    <GradientBackground>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.pageHeader}>
            ...
            <Text style={[styles.pageSubtitle, { color: theme.textSecondary }]}>Customize your coordination dashboard look and feel.</Text>
        </View>
        ...
        <GlassCard style={[styles.formCard, { backgroundColor: theme.card }]}>
            ...
            <ToggleItem 
                ...
                desc="Download students lists automatically"
                value={autoUpdate}
