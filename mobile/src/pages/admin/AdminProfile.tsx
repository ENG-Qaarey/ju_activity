...
import { X, User, Mail, Shield, Bell, CircleHelp, LogOut, ChevronRight, Settings, LayoutDashboard, Database, Lock } from 'lucide-react-native';
      ...
      >
        ...
        <View style={styles.header}>
          ...
          >
            ...
            />
            <View style={[styles.adminBadge, { borderColor: theme.card, backgroundColor: '#EF4444' }]}>
          ...
          <View style={[styles.roleLabel, { backgroundColor: theme.primary + '20' }]}>
              <Text style={[styles.roleText, { color: theme.primary }]}>{t.profile.adminRole}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <ThemedText style={[styles.sectionTitle, { color: theme.textSecondary, textAlign: isRTL ? 'right' : 'left' }]}>
            {t.profile.consoleManagement}
          </ThemedText>
          <GlassCard style={[styles.card, { backgroundColor: theme.card }]}>
            <ProfileItem icon={LayoutDashboard} label={t.profile.consoleCustomization} color="#0EA5E9" theme={theme} isRTL={isRTL} />
            <ProfileItem icon={Database} label={t.profile.systemBackup} color="#8B5CF6" theme={theme} isRTL={isRTL} />
            <ProfileItem icon={Lock} label={t.profile.securityProtocols} color="#F59E0B" theme={theme} isRTL={isRTL} />
          </GlassCard>
        </View>
        ...
        <View style={styles.section}>
          ...
          <GlassCard style={[styles.card, { backgroundColor: theme.card }]}>
            <ProfileItem 
                ...
                onPress={() => router.push('/(admin)/settings/personal')}
                theme={theme}
                isRTL={isRTL}
            />
            <ProfileItem 
                icon={Bell} 
                label={t.profile.globalNotifications} 
            ...
            <ProfileItem 
                ...
                onPress={() => router.push('/(admin)/settings/preferences')}
                theme={theme}
                isRTL={isRTL}
            />
          </GlassCard>
        ...
        <View style={styles.section}>
          <ThemedText style={[styles.sectionTitle, { color: theme.textSecondary, textAlign: isRTL ? 'right' : 'left' }]}>
            {t.profile.systemSupport}
          </ThemedText>
          <GlassCard style={[styles.card, { backgroundColor: theme.card }]}>
            <ProfileItem icon={CircleHelp} label={t.profile.adminDocumentation} theme={theme} isRTL={isRTL} />
        ...
        <View style={styles.viewerOverlay}>
          ...
          >
            <View style={styles.viewerContent}>
              ...
              <ThemedText style={styles.viewerName}>{user?.name || 'Admin User'}</ThemedText>
            </View>
          </TouchableOpacity>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  adminBadge: { position: 'absolute', right: 4, bottom: 4, padding: 6, borderRadius: 12, borderWidth: 2 },
